...
func TestBAddI64(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			y:     make([]int64, 4),
			want:  []int64{-50, 50, -50, 50},
		},
		{
			name:  "Random large values",
			numel: 4,
			x1:    []int64{1234567890, -9876543210, 5555555555, -1111111111},
			x2:    []int64{987654321, -123456789, 4444444444, 2222222222},
			y:     make([]int64, 4),
			want:  []int64{2222222211, -10000000000, 9999999999, 1111111111}, // Verified with PyTorch: torch.tensor([1234567890,-9876543210,5555555555,-1111111111], dtype=torch.int64) + torch.tensor([987654321,-123456789,4444444444,2222222222], dtype=torch.int64)
		},
	}
