...
func ExampleZero() {
	fmt.Println(tensor.Zero([]int{2, 3}))
...
func Example_add() {
	fmt.Println(tensor.AddGrad(nil, tensor.New(1)))
	fmt.Println(tensor.AddGrad(tensor.New(1), tensor.New(2)))
